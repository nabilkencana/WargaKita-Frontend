...
''';
  ...
  Future<void> _sendReportViaWhatsApp({
    ...
    try {
      ...
      final whatsappNumber = '+6285648898807'; // Ganti dengan nomor support
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () => _makePhoneCall("+6285648898807"),
          ...
          child: Column(
            ...
            children: [
              ...
              _buildContactItem(
                ...
                'nabilkencana20@gmail.com',
                Colors.blue.shade700,
                () => _sendEmail('nabilkencana20@gmail.com'),
              ),
              const SizedBox(height: 12),
              _buildContactItem(
                Icons.chat_bubble,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: ['Umum', 'Teknis', 'Akun', 'Dokumen'].map(
                              (category) {
                                return ChoiceChip(
                                  label: Text(category),
                          ...
                          // Screenshot - OPTIONAL (bisa di-skip jika masih lag)
                          GestureDetector(
                            onTap: () async {
                              final picker = ImagePicker();
                              final pickedFile = await picker.pickImage(
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              Navigator.pop(context);
                              // Buka dialog pilihan
                              _showDeliveryMethodDialog(context).then((method) {
                                if (method == 'email') {
                                  _sendReportViaEmail(
                                    category: selectedCategory,
                                    description: problemController.text,
            ...
            return Dialog(
              ...
              child: Container(
                constraints: BoxConstraints(
                  ...
                  maxWidth: 400, // Batasi lebar maksimum
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              margin: const EdgeInsets.only(bottom: 16),
                              child: CircleAvatar(
                                radius: 32, // Kecilkan radius
                                backgroundColor: Colors.amber.shade100,
                                child: Icon(
                                  Icons.person,
                                  size: 32, // Kecilkan icon
                                  color: Colors.amber.shade800,
                                ),
                              ),
                            ),
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Icon(
                                        ...
                                        size: 40, // Kecilkan ukuran bintang
                                      ),
                                    ),
                                  );
                                }),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextField(
                                    ...
                                    maxLines: 3, // Kurangi max lines
                                    maxLength: 200, // Kurangi max length
                                    decoration: InputDecoration(
                                      hintText:
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          // Tombol Kirim - TEKS LEBIH PENDEK
                          SizedBox(
                            width: double.infinity,
                            child: ElevatedButton(
